		...
		<div class="content">
            ...
            <div class="form-row">
                ...
                <div class="input-col has-checkbox">
                    <label><input id="private" type="checkbox" name="private" {{ old('private')? 'checked="checked"' : '' }}> <span>Yes</span></label>
                </div>
                <div class="input-notes">
                    <span class="note">Private forms will not submit data to users. Will email only site admins.</span>
                </div>
            </div>
			...
			<div class="form-row">
				...
				<div class="input-col">
					<input id="subject" type="text" name="subject" value="{{ old('subject') }}" autocomplete="off" required>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="input-col">
					<input id="email-to" type="text" name="email_to" value="{{ old('email_to') }}" autocomplete="off" required>
				</div>
				<div class="input-notes">
			...
			<div class="form-row">
				...
				<div class="input-col">
					<input id="email-from" type="email" name="email_from" autocomplete="off" value="{{ old('email_from') }}">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="input-col">
					<input id="email-cc" type="text" name="email_cc" autocomplete="off" value="{{ old('email_cc') }}">
				</div>
				<div class="input-notes">
				    <span class="note">Comma separated list</span>
				</div>
			...
			<div class="form-row">
				...
				<div class="input-col">
					<input id="email-bcc" type="text" name="email_bcc" autocomplete="off" value="{{ old('email_bcc') }}">
				</div>
				<div class="input-notes">
				    <span class="note">Comma separated list</span>
				</div>
