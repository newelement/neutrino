	...
	<div class="container">
		<div class="content">
			...
			<div class="form-row">
				...
				<div class="input-col">
					<input id="name" class="to-slug" type="text" name="place_name" value="{{ old('place_name') }}" autocomplete="off" required>
				</div>
			</div>
		...
		<aside class="sidebar">
			...
			<div class="side-fields">
				...
				<button type="submit" class="btn full text-center">Create Place</button>
			</div>
